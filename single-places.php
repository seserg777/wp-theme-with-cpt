        ...
        while (have_posts()) :
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="places-info">
                    ...
                    <?php else : ?>
                        <?php if (!empty($placeDetails['street'])) : ?>
                            <div class="places-info-item places-street">
                                <span class="places-icon dashicons dashicons-location"></span>
                                <div class="places-info-content">
                                    <strong><?php esc_html_e('Street:', 'mytheme'); ?></strong>
                                    <p><?php echo esc_html($placeDetails['street']); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                        
                        <?php if (!empty($placeDetails['number'])) : ?>
                            <div class="places-info-item places-number">
                                <span class="places-icon dashicons dashicons-location-alt"></span>
                                <div class="places-info-content">
                                    <strong><?php esc_html_e('Number:', 'mytheme'); ?></strong>
                                    <p><?php echo esc_html($placeDetails['number']); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
